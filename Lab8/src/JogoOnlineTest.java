...
//        }
    ...
    public void testarSenhaInvalida() throws SenhaInvalidaException, UsuarioInexistenteException {
        Jogador jogadoraMaria = jogo.cadastrarJogador("maria", "3456");
        jogo.fazerLogin("maria", "vasco");
    }
    ...
    public void obterJogadoresEmOrdemAlfabeticaTest(){
        ...
        assertEquals("AAAAA", jogo.obterJogadoresEmOrdemAlfabetica().get(0).getUsername());
        assertEquals("CCCCC", jogo.obterJogadoresEmOrdemAlfabetica().get(2).getUsername());
    }
    ...
    public void obterRankingTest(){
        ...
        assertEquals(999, jogo.obterRanking().get(2).getPontuacao());
    }
}